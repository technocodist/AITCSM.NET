...
public class FreeFall : EntityBase
{
    ...
    public virtual List<FreeFallStepResult> Results { get; protected set; } = [];
}


public class FreeFallStepResult : EntityBase
{
    public int FreeFallId { get; set; }
